...
def LoadTexture(name):
    ...
    # Create Texture
    id = glGenTextures(1)  #generate texture names, n Specifies the number of texture names to be generated.
    glBindTexture(GL_TEXTURE_2D, id)  # bind Texture, 2d texture (x and y size)

    glPixelStorei(GL_UNPACK_ALIGNMENT, 1) #control how pixel data is stored in memory and how it is interpreted by OpenGL function
