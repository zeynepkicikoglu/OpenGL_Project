...
class Object3D(Object):
    ...
    def draw(self):
        ...
        if (loc == -1) :
            print("No uniform variable : rotation_model")
...
class Text(Object):
    ...
    def draw(self):
        ...
        if (loc == -1) :
            print("No uniform variable : size")
